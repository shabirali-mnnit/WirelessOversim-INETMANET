...
#ifndef __WIRELESSUNDERLAYCONFIGURATOR_H__
#define __WIRELESSUNDERLAYCONFIGURATOR_H__
 ...
 */
class WirelessUnderlayConfigurator : public UnderlayConfigurator
{
public:
    ~WirelessUnderlayConfigurator();
